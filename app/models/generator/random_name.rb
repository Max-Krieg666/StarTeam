module Generator
  class RandomName
    ...
    def rand_name
      ...
      case @country_id
      when 1, 7, 10, 15, 17, 20, 23, 39, 45, 57, 65, 125, 130, 145, 146, 147, 149,
           157, 172, 177, 178, 179, 199, 235, 239, 241, 244, 252
        # Австралия, Ангилья, Антигуа и Барбуда, Багамы, Барбадос, Белиз, Бермуды,
        # Виргинские острова, Гайана, Гренада, Доминика, Микронезия, федеративные штаты,
        # Монтсеррат, Остров Мэн, Остров Норфолк, Острова Кайман, Острова Теркс и Кайкос,
        # Питкерн, Остров Святой Елены, Сент-Винсент и Гренадины, Сент-Китс и Невис,
        # Сент-Люсия, Тринидад и Тобаго, Ямайка, Англия, Кокосовые острова (Килинг),
        # Остров Рождества, Южная Георгия и Южные Сандвичевы Острова
        file_names = 'english'
      ...
      when 6, 165, 40, 61, 174
        # Американское Самоа, США, Британские, Виргинские острова,
        # США, Гуам, Северные Марианские острова
        file_names = 'american'
        file_lastnames = 'english'
      when 8
        # Ангола
      ...
      when 9, 11, 38, 49, 54, 55, 66, 79, 92, 96, 98, 124, 138, 153, 155, 156,
           166, 208, 222, 227, 240
        # Андорра, Аргентина, Венесуэла, Гватемала, Гибралтар, Гондурас,
        # Доминиканская Республика, Испания, Колумбия, Коста-Рика, Куба, Мексика, Никарагуа,
        # Панама, Парагвай, Перу, Сальвадор, Уругвай, Чили, Эквадор, Канарские острова
        word =
          if @country_id == 79
            chance = SecureRandom.random_number(500)
            if chance > 415
              'spain_basque'
            elsif chance < 86
              'spain_catalonian'
      ...
      when 18, 74, 75, 81, 87, 99, 106, 143, 144, 152, 170, 184
        # Бахрейн, Иордания, Ирак, Йемен, Катар, Кувейт, Ливан, Объединенные Арабские Эмираты,
        # Оман, Палестинская автономия, Саудовская Аравия, Сирийская Арабская Республика
        file_names = 'arabic'
      ...
      when 44, 48, 122, 128, 141, 161, 180, 207, 214, 215, 216, 242, 246
        # Гаити, Гваделупа, Мартиника, Монако, Новая Каледония, Реюньон, Сент-Пьер и Микелон,
        # Уоллис и Футуна, Франция, Французская Гвиана, Французская Полинезия, Майотта, Сен-Бартельми
        file_names = 'french'
      ...
      unless file_names.present?
        Rails.logger.error "Имён для страны #{@country_id} нет! Установлены английские!"
